...
# 添加第一个折线图轨迹
fig.add_trace(go.Scatter(x=curDuration2, y=velM1, mode='lines+markers', name='velM1'), row=1, col=2)

# 添加第二个折线图轨迹
fig.add_trace(go.Scatter(x=curDuration1, y=velM2, mode='lines+markers', name='velM2'), row=1, col=2)

fig.add_trace(go.Scatter(x=curDuration1, y=velM3, mode='lines+markers', name='velM3'), row=1, col=2)

fig.add_trace(go.Scatter(x=curDuration1, y=velS1, mode='lines+markers', name='velS1'), row=1, col=2)

fig.add_trace(go.Scatter(x=curDuration1, y=velS2, mode='lines+markers', name='velS2'), row=1, col=2)
